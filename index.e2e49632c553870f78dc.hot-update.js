...
const useSortedList = (list, searchQuery) => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    setSortedList(list.filter(item => getMatchesWithSearchQuery(item.name, searchQuery) || getMatchesWithSearchQuery(item.area.name, searchQuery)));
  }, [list, searchQuery]);
  return [sortedList];
};
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("c06b0c5ef5a9b90129ce")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.e2e49632c553870f78dc.hot-update.js.map