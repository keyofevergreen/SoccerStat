...
const CompetitionCalendar = _ref => {
  ...
  const [rangeValue, setRangeValue] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(['', '']);
  const sortedMatchesByTime = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => [...matches].sort((a, b) => getDate(b.utcDate).diff(getDate(a.utcDate))), [matches]);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("4c74a3852feb18cc25f5")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.fd174187412940326027.hot-update.js.map